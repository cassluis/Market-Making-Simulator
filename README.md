...
Reconstructs a CME limit order book from MDP3 market-by-order data and simulates quoting against it. Research code — built to study market making, not to trade it.
